...
-(BOOL)tableViewMoreThanOne;
{
    if ([[self scrollView] isKindOfClass:[UITableView class]]) {
        UITableView *tableView = (UITableView*)[self scrollView];
        return ([tableView numberOfSections]>1 || ([tableView numberOfSections]==1 && [tableView numberOfRowsInSection:0]>1));
    }
...
- (BOOL)_shouldHandleScrolling
{
    ...
    return (self.isViewControllerVisible && scrollViewIsSuffecientlyLong && [self tableViewMoreThanOne]);
}
